...
class TurkeyService {
  ...
  getData = () => {
    dataTar.forEach((el) => {
      el.properties["pump"] = parseFloat(el.properties.Pumping_m3);
      el.properties["DD"] = parseFloat(el.properties.Drawdown_m);
      el.properties["SPC"] = parseFloat(el.properties.Specific_capacity);
    });
    return {
