...
import distData from "./distrct-ger.json"
            ...
            getLegend=()=>{
                return <>
                <div style={{ width: "20px", height: "20px", backgroundColor: this.getLegendColor(1000) }}><span className="legend-span">{">"}1000</span></div>
                <div style={{ width: "20px", height: "20px", backgroundColor: this.getLegendColor(2000) }}><span className="legend-span">{">"}2000</span></div>
                <div style={{ width: "20px", height: "20px", backgroundColor: this.getLegendColor(3000) }}><span className="legend-span">{">"}3000</span></div>
                <div style={{ width: "20px", height: "20px", backgroundColor: this.getLegendColor(5000) }}><span className="legend-span">{">"}5000</span></div>
                <div style={{ width: "20px", height: "20px", backgroundColor: this.getLegendColor(6000) }}><span className="legend-span">{">"}6000</span></div>
                <div style={{ width: "20px", height: "20px", backgroundColor: this.getLegendColor(9000) }}><span className="legend-span">{">"}8000</span></div>
        ...
        class SecondMap extends React.Component {
            ...
            getFeature=(location)=>{
                ...
                console.log("hello")
                let services =this.state.locationServices[location]
            ...
            render(){
                ...
                <div class="topnav">
                    ...
                    <a href="#news" onClick={()=>{
                       ...
                       this.getFeature("Turkey")
                      
                    }}>Turkey</a>
                    <a href="#contact"  onClick={()=>{
                        this.goLocation(locations.Germany);
                        this.getFeature("Germany")
                    }}>Germany</a>
