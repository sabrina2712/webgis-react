...
if (selectedArea === location){
    ...
    */
    ...
    getContent = () => {
        ...
        return this.state.selectedLocation !== "Germany" ? <Turkey isDrawerOpen={this.state.isDrawerOpen} mapOnClick={this.mapOnClick} map={this.state.map} overLayer={this.state.overLayer} mapClick={this.state.mapClick} /> :
